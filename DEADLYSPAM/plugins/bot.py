...
LUCKY_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/74d37d422d816a405f452.jpg"
  

LUCKY = "✯ 𝗗𝗲𝗮𝗱𝗹𝘆 𝗦𝗽𝗮𝗺 𝗛𝗲𝗿𝗲 ✯\n\n"
LUCKY += f"═══════════════════\n"
LUCKY += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.10.1`\n"
LUCKY += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
LUCKY += f"• **ᴅᴇᴀᴅʟʏʙᴏᴛ ᴠᴇʀsɪᴏɴ**  : `{deadlyversion}`\n"
LUCKY += f"═══════════════════\n\n"   
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await BOT0.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/ALLSPAMROBOT"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/DX_LUCKY")
        ],
        [
        Button.url("• ʀᴇᴘᴏ •", "https://github.com/Kgf1235/LUCKY-SPAMBOT")
        ]
        ]
        )
